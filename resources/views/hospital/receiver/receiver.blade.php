        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">All Receivers
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-6 col-md-8">
                            <form method="get" action="{{route('hospital.receiver')}}">
                        ...
                        @if($model->count() > 0)
                            @foreach($model as $item)
                                <tr>
                                    ...
                                    <td>{{$item->email}}</td>
                                    <td>
                                        <a class="btn btn-success btn-sm" href="{{route('hospital.receiver.show',['id'=>$item->id])}}">
